<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Líder</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                <form method="POST" action="{{ route('coordinador.lideres.store') }}" class="space-y-5">
                    @csrf
                    ...
                    <div class="flex items-center gap-4 pt-4">
                        <x-primary-button>Crear Líder</x-primary-button>
