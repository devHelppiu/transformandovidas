        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <h3 class="text-sm text-gray-500">Comprador</h3>
                        <p class="font-medium">{{ $ticket->comprador_nombre }}</p>
                    </div>
                    <div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        @if($ticket->pago->estado === 'pendiente')
                            <div class="border-t pt-4 mt-4">
                                ...
                                <form method="POST" action="{{ route('ticket.comprobante', $ticket) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="space-y-4">
                                        <div>
            ...
            <div class="mt-4">
                <a href="{{ route('consulta.tickets') }}" class="text-sm text-gray-600 hover:text-gray-900">&larr; Buscar mis tickets</a>
            </div>
        </div>
    </div>
</x-app-layout>
